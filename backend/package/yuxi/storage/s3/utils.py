...
from .client import aupload_file_to_object_store
...
async def upload_image_to_object_store(
    upload: UploadFile,
    *,
    object_prefix: str,
    max_size_bytes: int,
    ...
    return await aupload_file_to_object_store("public", object_name, file_content)
