...
from yuxi.storage.s3 import upload_image_to_object_store
...
async def login_for_access_token(
    ...
    return {
        ...
        "avatar": normalize_public_object_url(user.avatar),
        "role": user.role,
...
async def upload_user_avatar(
    ...
    """上传用户头像"""
    try:
        avatar_url = await upload_image_to_object_store(
            file,
...
async def impersonate_user(
    ...
    return {
        ...
        "avatar": normalize_public_object_url(target_user.avatar),
