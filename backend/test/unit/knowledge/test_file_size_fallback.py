...
@pytest.mark.unit
class TestObjectStoreClientStatFile:
    """Test ObjectStoreClient.stat_file and astat_file methods."""
...
class TestAddFileRecordSizeFallback:
    ...
    async def test_add_file_record_fetches_size_from_minio_when_missing(self):
        ...
        mock_object_store.astat_file.return_value = 9999

        with patch("yuxi.storage.s3.get_object_store_client", return_value=mock_object_store):
            ...
            mock_object_store.astat_file.assert_called_once()
    ...
    async def test_add_file_record_keeps_provided_size(self):
        ...
        with patch("yuxi.storage.s3.get_object_store_client", return_value=mock_object_store):
            ...
            mock_object_store.astat_file.assert_not_called()
    ...
    async def test_add_file_record_size_fallback_handles_error_gracefully(self):
        ...
        mock_object_store = AsyncMock()
        mock_object_store.astat_file.side_effect = Exception("MinIO connection error")
