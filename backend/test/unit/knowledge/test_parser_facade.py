...
def test_slim_docx_preserves_embedded_image_bytes_and_markdown_position(
    ...
    monkeypatch.setattr(parser_unified, "_upload_image_to_object_store", _capture_upload)
...
def test_convert_with_docling_reinserts_image_links_in_document_order(
    ...
    def _fake_upload_image_to_object_store(image_data, filename, bucket_name, object_prefix):
        uploaded_images.append(image_data)
    ...
    monkeypatch.setattr(parser_unified, "_upload_image_to_object_store", _fake_upload_image_to_object_store)
...
def test_convert_with_docling_keeps_image_placeholder_when_upload_fails(
    ...
    monkeypatch.setattr(parser_unified, "_convert_office_document", lambda _path: fake_doc)
    monkeypatch.setattr(parser_unified, "_upload_image_to_object_store", _raise_upload_error)
