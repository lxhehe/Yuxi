...
export default defineConfig({
  lang: 'zh-CN',
  title: "Yuxi",
  description: "Yuxi 是一个可私有部署的多租户知识智能体平台，统一 RAG、LangGraph 多智能体、MCP/Skills、沙盒与权限管理。",
  base: '/Yuxi/',
  srcExclude: ['vibe/**'],
  sitemap: {
  ...
  head: [
    ...
    ['meta', { name: 'keywords', content: 'Yuxi, AI Agent, RAG, LangGraph, MCP, self-hosted, multi-agent, knowledge base' }],
    ...
    ['meta', { name: 'twitter:description', content: 'RAG, multi-agent execution, MCP/Skills, sandboxed artifacts, and access control in one workspace.' }],
    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: '知识库', link: '/intro/knowledge-base' },
